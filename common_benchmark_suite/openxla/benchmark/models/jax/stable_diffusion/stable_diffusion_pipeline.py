...
class StableDiffusionPipeline(model_interfaces.InferenceModel):
  ...
  def __init__(self, batch_size: int, seq_len: int, dtype: Any,
               model_name: str):
  ...
  def preprocess(self, input_prompt: str) -> Tuple[Any, Any]:
  ...
  def postprocess(self, output: Any) -> List[Image]:
